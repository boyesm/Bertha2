...
# IRC Twitch Integration has forced my hand, and i need a way to get a key from a "fake dictionary".
# The string that is inputted is scanned through for a certain key and it returns that part of the string+
...
class TwitchBot(irc.bot.SingleServerIRCBot):
    ...
    def on_pubmsg(self, c, e):
        ...
        if e.arguments[0][:1] == '!':
            ...
            print("Raw info from the package:", getKeyFromFakeDict("source",str(e)))
    ...
    def do_command(self, e, cmd):
        ...
        if cmd == "play":
            ...
            c.privmsg(self.channel,"The song has been added to the Queue")
